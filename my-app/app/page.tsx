...
export default function Home() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Data visualization platform with real-time updates, interactive charts, and custom reporting.",
      image:
    ...
    },
    {
      ...
      description:
        "Modern social networking platform with real-time messaging and AI-powered recommendations.",
      image:
    ...
    },
    {
      ...
      description:
        "Secure financial management platform with transaction tracking and investment tools.",
      image:
    ...
    },
    {
      ...
      description:
        "Comprehensive healthcare solution with patient records and telemedicine features.",
      image:
